...
function SheetPortal({
  ...
  container,
  ...props
}: SheetPrimitive.Portal.Props): React.JSX.Element {
...
function SheetTitle({ className, ...props }: SheetPrimitive.Title.Props) {
  return (
    <SheetPrimitive.Title
      ...
      className={cn("popup-text-xs-plus font-medium text-[color:var(--foreground)]", className)}
      {...props}
    />
  );
}
...
function SheetDescription({ className, ...props }: SheetPrimitive.Description.Props) {
  return (
    <SheetPrimitive.Description
      ...
      className={cn(
        "popup-text-xs-plus leading-relaxed text-[color:var(--muted-foreground)]",
        className,
      )}
      {...props}
    />
